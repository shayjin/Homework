/*****************************************/
/* Name: Jay Shin    Date: 11/15/2020    */
/* Seat: 00          File: ewa_08.cpp    */
...
int main ()
{  
//Closes the output file when the program is finished. 
  ...
  */
  ...
  /*
    Open the file
  */
  //Open the output fileEWA_08.txtfor writing, perform error checking when opening EWA_08.txt, and take the appropriate steps to quit the program if the file fails to open. 
  //Write everything to the file EWA_08.txtthat it writes to the screen. 
  output_file_ptr = fopen ("EWA_08.txt", "w");
  ...
  */
  printf ("\n\n");
  printf ("\t*****************************************************\n");
  printf ("\t*** Name: Jay Shin                                ***\n");
  printf ("\t*** Seat 29     Date:11/14/2020                   ***\n");
  printf ("\t*** Instructor: Brooke Morin    Assignment: EWA 08***\n");
  ...
  fprintf (output_file_ptr, "\t*****************************************************\n");
  fprintf (output_file_ptr, "\t*** Name: Jay Shin                                ***\n");
  fprintf (output_file_ptr, "\t*** Seat 29  Date: 11/14/2020                     ***\n");
  fprintf (output_file_ptr, "\t*** Instructor:  Brooke Morin  Assignment: EWA 08 ***\n");
  ...
  */
  //Initialize a one-dimensional int matrix with ten elements and a two-dimensional float matrix with twenty-five elements with zeroes.
  ...
  */
  //Loop indefinitely and prompts the user for commands to: 
  while (quit == FALSE)
    {
      /*
	...
	output file, too.
      */
      printf ("\n");
      //a, A - Display the one-dimensional matrix with its elements in a row  
      printf ("\n\ta, A\t-\tDisplay the one dimensional matrix as a row");
      //b, B - Display the one-dimensional matrix with its elements in a column 
      printf ("\n\tb, B\t-\tDisplay the one dimensional matrix as a column");
      //c, C - Fill the one-dimensional matrix beginning with the int of the user’s choosing, incrementing each element by 1. 
      fprintf (output_file_ptr, "\n\tq, Q\t-\tQuit");

      printf ("\n\tc, C\t-\tFill the one dimensional matrix with an int");
      //d, D - Display the two-dimensional matrix in five rows and five columns 
      printf ("\n\td, D\t-\tDisplay the two dimensional matrix");
      //e, E - Fill the two-dimensional matrix beginning with the float of the user’s choosing, incrementing each element by 0.5. 
	...
	case 'E':
	  ...
	  fgets (flush, MAX_BUFFER-1, stdin);
	  MatrixFill (*matrix, fvalue, ROWS, COLUMNS, output_file_ptr);
	...
	case 'Q':
	  ...
	  */
        //Error messages are provided if the user selects a command that is not a valid option.
	default:

	  printf ("\n\t*** Error:  Invalid operation ***\n\n");
	  fprintf (output_file_ptr, "\n\t*** Error:  Invalid operation ***\n\n");
	}
    //Once a command (except for Quit) completes execution, the user is prompted to perform another command.
    }
}
