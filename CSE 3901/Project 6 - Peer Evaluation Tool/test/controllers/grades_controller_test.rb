...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference("Grade.count") do
      post grades_url, params: { grade: { assignment: @grade.assignment, date: @grade.date, feedback: @grade.feedback, score: @grade.score } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { assignment: @grade.assignment, date: @grade.date, feedback: @grade.feedback, score: @grade.score } }
